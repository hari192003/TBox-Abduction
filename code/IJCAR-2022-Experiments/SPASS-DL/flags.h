...
/* State definitions for flag_DLSTOP */
typedef enum { flag_DLSTOPMIN = -1,
               flag_DLSTOPOFF = flag_OFF,
               flag_DLSTOPON  = flag_ON,
               flag_DLSTOPMAX
} FLAG_DLSTOPTYPE;

/* State definitions for flag_DLSIGBOUND */
typedef enum { flag_DLSIGBOUNDMIN = -1,
               flag_DLSIGBOUNDOFF = flag_OFF,
               flag_DLSIGBOUNDON  = flag_ON,
               flag_DLSIGBOUNDMAX
} flag_DLSIGBOUNDTYPE;

/* State definitions for flag_BOUNDVARS */
typedef enum { flag_BOUNDVARSMIN = -2,
	       flag_BOUNDVARSNONE = -1,
	       flag_BOUNDVARSMAX = INT_MAX
} FLAG_BOUNDVARSTYPE;
...
/* State definitions for flag_PPWARN */
typedef enum { flag_PPWARNMIN = -1,
               flag_PPWARNOFF = flag_OFF,
               flag_PPWARNON  = flag_ON,
               flag_PPWARNMAX
} flag_PPWARNTYPE;
...
typedef enum { flag_AUTO, flag_STDIN, flag_INTERACTIVE, flag_FLOTTER,
	       ...
	       flag_BOUNDMODE,  flag_BOUNDSTART, flag_BOUNDVARS,
	       ...
	       flag_PPWARN,                                       /*  print parser warnings */
