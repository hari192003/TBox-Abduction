...
static const char *const yytname[] =
{
  ...
  "quantsymbol", "id", "qtermlist", "qterm", "labellistopt", "labellist", YY_NULLPTR
};
#endif
...
#line 1522 "iaparser.c"
    break;

  case 16:
#line 163 "iaparser.y"
                                        { ia_VarStart(); }
#line 1528 "iaparser.c"
    break;

  case 17:
#line 164 "iaparser.y"
                                        { ia_VarStop(); }
#line 1534 "iaparser.c"
    break;
...
#line 1543 "iaparser.c"
    break;

  case 19:
#line 172 "iaparser.y"
                                        { (yyval.symbol) = fol_Equality(); }
#line 1549 "iaparser.c"
    break;

  case 20:
#line 173 "iaparser.y"
                                        { (yyval.symbol) = fol_Equiv();    }
#line 1555 "iaparser.c"
    break;

  case 21:
#line 174 "iaparser.y"
                                        { (yyval.symbol) = fol_Implied();  }
#line 1561 "iaparser.c"
    break;

  case 22:
#line 175 "iaparser.y"
                                        { (yyval.symbol) = fol_Implies();  }
#line 1567 "iaparser.c"
    break;

  case 23:
#line 178 "iaparser.y"
                                        { (yyval.symbol) = fol_And(); }
#line 1573 "iaparser.c"
    break;

  case 24:
#line 179 "iaparser.y"
                                { (yyval.symbol) = fol_Or();  }
#line 1579 "iaparser.c"
    break;

  case 25:
#line 182 "iaparser.y"
                                        { (yyval.symbol) = fol_Exist(); }
#line 1585 "iaparser.c"
    break;

  case 26:
#line 183 "iaparser.y"
                                        { (yyval.symbol) = fol_All(); }
#line 1591 "iaparser.c"
    break;

  case 27:
#line 186 "iaparser.y"
                                        { (yyval.string) = (yyvsp[0].string); }
#line 1597 "iaparser.c"
    break;

  case 28:
#line 187 "iaparser.y"
                                        { (yyval.string) = string_IntToString((yyvsp[0].number)); }
#line 1603 "iaparser.c"
    break;

  case 29:
#line 190 "iaparser.y"
                                        { (yyval.list) = list_List((yyvsp[0].term)); }
#line 1609 "iaparser.c"
    break;

  case 30:
#line 191 "iaparser.y"
                                        { (yyval.list) = list_Nconc((yyvsp[-2].list), list_List((yyvsp[0].term))); }
#line 1615 "iaparser.c"
    break;
...
#line 1654 "iaparser.c"
    break;

  case 33:
#line 225 "iaparser.y"
                                        { (yyval.list) = list_Nil(); }
#line 1660 "iaparser.c"
    break;

  case 34:
#line 226 "iaparser.y"
                                        { (yyval.list) = (yyvsp[-1].list); }
#line 1666 "iaparser.c"
    break;

  case 35:
#line 229 "iaparser.y"
                                        { (yyval.list) = list_List((yyvsp[0].string)); }
#line 1672 "iaparser.c"
    break;

  case 36:
#line 230 "iaparser.y"
                                        { (yyval.list) = list_Nconc((yyvsp[-2].list), list_List((yyvsp[0].string))); }
#line 1678 "iaparser.c"
    break;


#line 1682 "iaparser.c"
