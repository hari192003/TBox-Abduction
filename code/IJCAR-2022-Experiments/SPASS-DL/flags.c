...
***************************************************************/
{
  ...
  case flag_SPASS:
    ...
    /* DL Stopping Condition */
    flag_InitIntern(flag_DLSTOP, flag_UNIQUE, flag_INTEGER, "DLStop", flag_DLSTOPOFF, (char *)NULL,
                          flag_DLSTOPMIN, flag_DLSTOPMAX);
    /* DL Stopping Condition */
    flag_InitIntern(flag_DLSIGBOUND, flag_UNIQUE, flag_INTEGER, "DLSigBound", flag_DLSIGBOUNDOFF, (char *)NULL,
                          flag_DLSIGBOUNDMIN, flag_DLSIGBOUNDMAX);
...
/* 		    flag_SPLITHEURISTICMIN, flag_SPLITHEURISTICMAX); */
    ...
    /* The number of bound saturation vars */
    flag_InitIntern(flag_BOUNDVARS, flag_UNIQUE, flag_INTEGER, "BoundVars", flag_BOUNDVARSNONE, (char *)NULL,
		    flag_BOUNDVARSMIN, flag_BOUNDVARSMAX);
